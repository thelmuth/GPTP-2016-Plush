...
One of the drawbacks of tree-based genetic programming that we hope to avoid by using uniform genetic operators is the bloating of program sizes without corresponding improvements in fitness. 

Figure X plots the mean program size of the population during each generation of each run using the REG genetic operators.
