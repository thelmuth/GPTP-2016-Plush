...
One of the drawbacks of tree-based genetic programming that we hope to avoid by using uniform genetic operators is bloat of program sizes without corresponding improvements in fitness.
Figure~\ref{fig:programSizes} plots the mean program size of each population over time for each run using the REG genetic operators.
